...
public class Vector3
{
    ...
    public Vector3(EnumFacing direction, double amount) {
        x = direction.getFrontOffsetX() * amount;
        y = direction.getFrontOffsetY() * amount;
        z = direction.getFrontOffsetZ() * amount;
    }
    ...
    public Vector3 add(EnumFacing dir, double amount) {
    	return add(dir.getFrontOffsetX()*amount, dir.getFrontOffsetY()*amount, dir.getFrontOffsetZ()*amount);
    }
    ...
    public Vector3 sub(EnumFacing dir, double amount) {
    	return sub(dir.getFrontOffsetX()*amount, dir.getFrontOffsetY()*amount, dir.getFrontOffsetZ()*amount);
    }
